...
//        fragmentManager = getChildFragmentManager();
    ...
    public void initLayout() {
        if(!issavedInstanceState) {
            if(mMemberDataFragment == null) {
                mMemberDataFragment = MemberDataFragment.newInstance();
            }
            if(mSaleDataFragment == null) {
    ...
    protected void lazyLoadData() {
        ...
        if (isViewCreated) {
            initLayout();
            if(mMemberDataFragment != null) {
                mMemberDataFragment.lazyLoadData(); //重新刷新数据
            }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.rl_member:
                ...
                if(mMemberDataFragment != null) {
                    showFragment(mMemberDataFragment);
                    mMemberDataFragment.lazyLoadData();
                    if (mSaleView != null) {
                        mSaleView.setVisibility(View.GONE);
                    }
                    if (mSaleText != null) {
            ...
            case R.id.sale_rl:
                ...
                if(mSaleDataFragment != null) {
                    ...
                    mSaleDataFragment.lazyLoadData();
                    if (mMemberView != null) {
