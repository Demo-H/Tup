...
public class NetWorkUrl {
    ...
    public static final String STORE_INFO = "store_info"; //专卖店信息接口
    public static final String STORE_INTEGRAL = "store_integral"; //惠金币列表
    public static final String STORE_COUPON = "store_coupon"; //优惠券列表
