...
import com.android.dhunter.common.volley.VolleyLog.MarkerLog;
...
public abstract class Request<T> implements Comparable<Request<T>> {
    ...
    public byte[] getBody() throws AuthFailureError {
        ...
        if (params != null && params.size() > 0) {
            if (params.containsKey("other")) {
                return addFormField(params, getParamsEncoding());
            }else {
    ...
    private byte[] addFormField(Map<String, String> params, String paramsEncoding) {
