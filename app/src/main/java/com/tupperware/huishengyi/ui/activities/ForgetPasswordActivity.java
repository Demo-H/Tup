...
import com.tupperware.huishengyi.ui.component.DaggerForgetPasswordActivityComponent;
...
import com.tupperware.huishengyi.ui.presenter.ForgetPasswordPresenter;
...
//        ActivityManager.getInstance().removeActivity(this);
    ...
    public void setPhoneData(ForgetPwInfo forgetPwInfo) {
        ...
        submitstep = 2;
        mPhoneString = forgetPwInfo.model.getEmployee_mobile();
        employeeId = forgetPwInfo.model.getEmployee_id();
        employeeGroup = forgetPwInfo.model.getEmployee_group();
        employeeCode = forgetPwInfo.model.getEmployee_code();
