...
public class ProductVefiryActivity extends BaseActivity implements TupVolley.TupVolleyListener, TupVolley.TupVolleyErrorListener {
...
//    TextView productVerifyTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_product_vefiry);
...
//                        productCodeTextView.setText(productCode);
    ...
    private String getStoreCode() {
        String name = (String) mSharePreDate.getParam(Constants.KEY_DATA_USERNAME,"0000");
        return name;
    }

    /**
     * 异步加载数据数据,完成请求的url与筛选条件的添加，把请求添加到请求队列,手动验证产品唯一码
     */
    private void asyncLoadingProduct(int requestCode, String code) {
        Map<String, String> params = new HashMap<>();
        params.put("qrCode", Constants.SCAN_COUPON_ONLY_CODE);
        params.put("uniqueCode", code);
        mTupVolley.post(requestCode, ServerURL.VEFIRY_PRODUCT, params, this, this, headerparams);
    }
