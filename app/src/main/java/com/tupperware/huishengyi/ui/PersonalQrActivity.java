...
import com.tupperware.huishengyi.component.DaggerPersonalQrActivityComponent;
...
//        mStoreImage.setImageURI(mBean.model.logo);
        mStoreTitle.setText(mBean.model.name);
        mStoreCode.setText(mBean.model.code);
//        showQrImage(mBean.model.logo);
        mQrIcon.setImageURI(mBean.model.logo);
    }
