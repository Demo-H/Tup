...
public class ReserCarnivalActivity extends BaseActivity {
    private static final String TAG = "ReserCarnivalActivity";
    ...
    protected void initLayout() {
        ...
        mBaseInfoTitle.setVisibility(View.GONE);
        mTagFlowLayout.setVisibility(View.GONE);
        mBrandModelRl.setVisibility(View.GONE);
    }
    ...
    @OnClick({R.id.left_back, R.id.next, R.id.call_contacts, R.id.server_time_rl, R.id.waiter_rl})
