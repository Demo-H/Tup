...
import com.tupperware.biz.ui.component.DaggerRegisterActivityComponent;
import com.tupperware.biz.ui.contract.RegisterContract;
import com.tupperware.biz.ui.module.RegisterPresenterModule;
import com.tupperware.biz.ui.presenter.RegisterPresenter;
...
//                    getSMSCode();
    ...
    private void startRegister() {
        ...
        if (verifyProduct != null) {
            member_id = verifyProduct.model.getMembers().getMemberId();
        }
        ...
        request.setSmsCode(mSmsCodeString);
        request.setMemberName(mCustomerNickString);
        request.setMobile(mCustomerNumberString);
        if(member_id == null || member_id.equals("0")) {
            request.setMemberId((Integer) mDataManager.getSpObjectData(Constants.FANS_MEMBER_ID, -1));
        } else {
