...
import com.tupperware.huishengyi.ui.component.DaggerScanCouponActivityComponent;
...
import com.tupperware.huishengyi.ui.presenter.ScanCouponPresenter;
...
//            asyncLoading(Constants.REQUEST_CODE_CHECK_PRODUCT, productCode);
    ...
    @OnClick({R.id.left_back, R.id.activity_can_not_scan, R.id.activity_scancoupon_tip})
