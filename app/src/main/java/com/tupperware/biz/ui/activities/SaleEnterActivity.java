...
public class SaleEnterActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null) {
            ...
            mHandFragment = (SaleHandFragment) fragmentManager.findFragmentByTag(SaleHandFragment.class.getName());
    ...
    protected void onResume() {
        super.onResume();
        if(currentFragment != mScanFragment) {
            mScanFragment.setUserHint();
        }
        if(currentFragment == mHistoryFragment && mHistoryFragment != null) {
            mHistoryFragment.lazyLoadData();
        }
    }
