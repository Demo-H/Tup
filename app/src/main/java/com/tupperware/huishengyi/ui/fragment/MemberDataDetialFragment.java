...
//        mPieChart.setCenterTextTypeface(tf); //设置字体
    ...
    private void refreshFans(MemberReportBean memberReportBean) {
        ...
        mMonthTargetZhaomuStatus.setText(monthFansCount + "个/" + monthFansTargetCount + "个");
        mSeasonTargetZhaomuStatus.setText(quarterFansCount + "个/" + quarterFansTargetCount + "个");
        mYearTargetZhaomuStatus.setText(yearFansCount + "个/" + yearFansTargetCount + "个");
    ...
    private void refreshCommonMember(MemberReportBean memberReportBean) {
        ...
        mMonthTargetZhaomuStatus.setText(monthCommonMemberCount + "个/" + monthCommonMemberTargetCount + "个");
        mSeasonTargetZhaomuStatus.setText(quarterCommonMemberCount + "个/" + quarterCommonMemberTargetCount + "个");
        mYearTargetZhaomuStatus.setText(yearCommonMemberCount + "个/" + yearCommonMemberTargetCount + "个");
    ...
    private void refreshVipMember(MemberReportBean memberReportBean) {
        ...
        mMonthTargetZhaomuStatus.setText(monthVipMemberCount + "个/" + monthVipMemberTargetCount + "个");
        mSeasonTargetZhaomuStatus.setText(quarterVipMemberCount + "个/" + quarterVipMemberTargetCount + "个");
        mYearTargetZhaomuStatus.setText(yearVipMemberCount + "个/" + yearVipMemberTargetCount + "个");
