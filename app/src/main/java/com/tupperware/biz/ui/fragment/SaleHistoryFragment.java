...
import com.tupperware.biz.adapter.SaleHistoryAdapter;
...
import com.tupperware.biz.ui.component.DaggerSaleHistoryFragmentComponent;
import com.tupperware.biz.ui.contract.SaleHistoryContract;
import com.tupperware.biz.ui.module.SaleHistoryPresenterModule;
import com.tupperware.biz.ui.presenter.SaleHistoryPresenter;
...
//    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.after_day:
                currentSelect = mSelectDay.getText().toString().trim();
                if(DateFormatter.isHistory(selectDate)) {
    ...
    private void chooseDate() {
        ...
        dialog.setTargetFragment(SaleHistoryFragment.this, Constant.REQUEST_DATE);
