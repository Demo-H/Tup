...
import com.tupperware.biz.adapter.MemberBenefitDetialAdapter;
import com.tupperware.biz.adapter.MemberCouponDetialAdapter;
...
import com.tupperware.biz.ui.component.DaggerMemberBenefitDetialFragmentComponent;
...
import com.tupperware.biz.ui.presenter.MemberBenefitDetialPresenter;
...
//        requestData();
    ...
    @Override
    public void setMemberBenefitDetialData(CouponResponse benefitCoinExpenditure) {
        if(Constant.COUPON.equals(mSelectTile)) {
            mCouAdapter.addData(benefitCoinExpenditure.getModels());
        } else if(Constant.BENEFIT.equals(mSelectTile)) {
            mBenAdapter.addData(benefitCoinExpenditure.getModels());
        }
    }
