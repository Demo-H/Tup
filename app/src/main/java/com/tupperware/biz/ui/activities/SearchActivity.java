...
public class SearchActivity extends BaseActivity {
    ...
    @BindView(R.id.order_cancel_input_text)
    ...
    private void init() {
        if(Constant.ORDER_FRAGMENT.equals(activity_from)) {
            ...
            if(mOrderFragment != null) {
                ...
                mOrderFragment.setEditTextCancel(mOrderCancelInputText);
            }
        } else {
            ...
            if(mOrderFragment != null) {
                ...
                mOrderFragment.setEditTextCancel(mCancelInputText);
            }
            if(mMemberFragment != null) {
                mMemberFragment.setEditText(mSearchEdit);
                mMemberFragment.setEditTextCancel(mCancelInputText);
            }
        }
    ...
    @OnClick({R.id.search, R.id.order_search, R.id.search_cancel, R.id.order_search_cancel, R.id.search_choose_title_ll})
