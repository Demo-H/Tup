...
import com.tupperware.huishengyi.adapter.OnlineOrderDetialAdapter;
import com.tupperware.huishengyi.component.DaggerOnlineOrderDetialActivityComponent;
...
import com.tupperware.huishengyi.ui.presenter.OnlineOrderDetialPresenter;
...
public class OnlineOrderDetialActivity extends BaseActivity implements OnlineOrderDetialContract.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_online_order_detial);
...
//            case Constant.CLOSED:
    ...
    private void refreshUIwithData(OrderItemBean orderItemBean) {
        if(orderItemBean != null && orderItemBean.model != null) {
            ...
            mOrderDate.setText(new DateFormatter().DatetoString(orderItemBean.model.buytime));
